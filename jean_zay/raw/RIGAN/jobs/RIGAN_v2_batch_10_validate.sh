#!/bin/bash
#SBATCH --job-name=val_RIGAN_v2_batch10    # nom du job
...
cd /lustre/fswork/projects/rech/rbn/ulx23va/projects/unrolled_cGAN/repos/rcGAN/scripts/radio_v2/
...
srun python -u validate_v2.py \
    --config /lustre/fswork/projects/rech/rbn/ulx23va/projects/unrolled_cGAN/repos/submission-scripts/jean_zay/raw/RIGAN/configs/radio_meerkat_macro-v2_batch_10.yml \
