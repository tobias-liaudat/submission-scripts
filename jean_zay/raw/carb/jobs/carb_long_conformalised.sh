#!/bin/bash
#SBATCH --job-name=carb_std_long_conformalised    # nom du job
...
srun python -u ./scripts/main.py \
    --config /lustre/fswork/projects/rech/rbn/ulx23va/projects/CARB/repos/submission-scripts/jean_zay/raw/carb/configs/carb_conformalised_config.yml -s
