#!/bin/bash
#SBATCH --job-name=coverage_plot_full_run    # nom du job
...
srun python -u ./scripts/coverage_plot_script.py \
    --config /lustre/fswork/projects/rech/rbn/ulx23va/projects/CARB/repos/submission-scripts/jean_zay/raw/carb/configs/coverage_plot_full_run_config.yml -s
