#!/bin/bash
#SBATCH --job-name=coverage_plots    # nom du job
...
srun python -u ./scripts/coverage_plot_script.py \
    --config /lustre/fswork/projects/rech/rbn/ulx23va/projects/CARB/repos/submission-scripts/jean_zay/raw/carb/configs/coverage_plot_config.yml -s
