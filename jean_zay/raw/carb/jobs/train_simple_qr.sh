#!/bin/bash
#SBATCH --job-name=train_simple_qr    # nom du job
...
srun python -u ./scripts/train_simple_qr.py \
    --config /lustre/fswork/projects/rech/rbn/ulx23va/projects/CARB/repos/submission-scripts/jean_zay/raw/carb/configs/train_simple_qr.yml -s
