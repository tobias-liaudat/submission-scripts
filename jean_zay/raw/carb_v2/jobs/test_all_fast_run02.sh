#!/bin/bash
#SBATCH --job-name=krcps_test_all_fast_run02    # nom du job
...
srun python -u krcps_lambdas.py \
    -c /lustre/fswork/projects/rech/rbn/ulx23va/projects/CARB/repos/submission-scripts/jean_zay/raw/carb_v2/configs/carb_config_krcps_run02.yml
