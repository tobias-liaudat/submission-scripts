#!/bin/bash
#SBATCH --job-name=PR_gaussian_benchmark_prox    # nom du job
...
#SBATCH --output=PR_gaussian_benchmark_prox-%x_%A_%a.out  # nom du fichier de sortie
#SBATCH --error=PR_gaussian_benchmark_prox-%x_%A_%a.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u ./gaussian_benchmark_prox.py -s 
