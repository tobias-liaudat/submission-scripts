#!/bin/bash
#SBATCH --job-name=lipschitz_BSD    # nom du job
...
srun python -u $WORK/projects/projects-ns/myDenoisers/scripts/runner_check_denoiser_lipschitz.py \
    -c ./raw/mydenoisers/configs/lipschitz_BSD_dncnn.yml -s

srun python -u $WORK/projects/projects-ns/myDenoisers/scripts/runner_check_denoiser_lipschitz.py \
    -c ./raw/mydenoisers/configs/lipschitz_BSD_lip_dncnn.yml -s

srun python -u $WORK/projects/projects-ns/myDenoisers/scripts/runner_check_denoiser_lipschitz.py \
    -c ./raw/mydenoisers/configs/lipschitz_BSD_unet.yml -s
