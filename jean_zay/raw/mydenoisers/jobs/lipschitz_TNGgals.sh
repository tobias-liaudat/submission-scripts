#!/bin/bash
#SBATCH --job-name=lipschitz_TNGgals    # nom du job
...
srun python -u $WORK/projects/projects-ns/myDenoisers/scripts/runner_check_denoiser_lipschitz.py \
    -c ./raw/mydenoisers/configs/lipschitz_TNGgals_dncnn.yml -s

srun python -u $WORK/projects/projects-ns/myDenoisers/scripts/runner_check_denoiser_lipschitz.py \
    -c ./raw/mydenoisers/configs/lipschitz_TNGgals_lip_dncnn.yml -s

srun python -u $WORK/projects/projects-ns/myDenoisers/scripts/runner_check_denoiser_lipschitz.py \
    -c ./raw/mydenoisers/configs/lipschitz_TNGgals_unet.yml -s
