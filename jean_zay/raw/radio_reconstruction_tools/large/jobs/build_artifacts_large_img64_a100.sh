#!/bin/bash
#SBATCH --job-name=rrt_large_img64_build_artifacts
...
#SBATCH --time=10:00:00              # 1000 op-norms x2 backends + PSF bank; large margin
...
CONFIG_TKBN=$CONFIG_DIR/large_run_img64_unrolled_n15_prior_DRUNet_op_tkbn_4gpus.yaml
CONFIG_PSF=$CONFIG_DIR/large_run_img64_unrolled_n15_prior_DRUNet_PSF_finufft_4gpus.yaml
ART_TKBN=/lustre/fswork/projects/rech/ney/ulx23va/projects/radio/outputs/artifacts/large_img64_cov1000_ntrain4000_tkbn
ART_PSF=/lustre/fswork/projects/rech/ney/ulx23va/projects/radio/outputs/artifacts/large_img64_cov1000_ntrain4000_psf_finufft
