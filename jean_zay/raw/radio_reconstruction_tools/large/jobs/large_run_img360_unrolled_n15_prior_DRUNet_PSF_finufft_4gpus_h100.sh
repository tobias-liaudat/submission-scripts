...
# ===========================================================================
# Self-chaining 4-GPU (DDP) H100 training job for the img360 large run (psf).
...
# Launch:  cd .../large/jobs/logs && sbatch ../large_run_img360_unrolled_n15_prior_DRUNet_PSF_finufft_4gpus_h100.sh
# ===========================================================================
...
JOB_SCRIPT=$SUBMISSION_REPO/jean_zay/raw/radio_reconstruction_tools/large/jobs/large_run_img360_unrolled_n15_prior_DRUNet_PSF_finufft_4gpus_h100.sh
