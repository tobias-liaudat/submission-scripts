#!/bin/bash
#SBATCH --job-name=rrt_large_img360_tkbn_4gpu
...
# ===========================================================================
# Self-chaining 4-GPU (DDP) A100 training job for the img360 large run (tkbn).
...
# Launch:  cd .../large/jobs/logs && sbatch ../large_run_img360_unrolled_n15_prior_DRUNet_op_tkbn_4gpus_a100.sh
# ===========================================================================
...
JOB_SCRIPT=$SUBMISSION_REPO/jean_zay/raw/radio_reconstruction_tools/large/jobs/large_run_img360_unrolled_n15_prior_DRUNet_op_tkbn_4gpus_a100.sh
CONFIG=$SUBMISSION_REPO/jean_zay/raw/radio_reconstruction_tools/large/configs/large_run_img360_unrolled_n15_prior_DRUNet_op_tkbn_4gpus.yaml
OUTPUT_ROOT=/lustre/fswork/projects/rech/ney/ulx23va/projects/radio/outputs/trained_models

BASE_NAME=large_run_img360_unrolled_n15_prior_DRUNet_op_tkbn_4gpus
