#!/bin/bash
#SBATCH --job-name=rrt_large_img64_psf_4gpu
...
# ===========================================================================
# Self-chaining 4-GPU (DDP) A100 training job for the img64 large run (psf).
...
# Launch:  cd .../large/jobs/logs && sbatch ../large_run_img64_unrolled_n15_prior_DRUNet_PSF_finufft_4gpus_a100.sh
# ===========================================================================
...
JOB_SCRIPT=$SUBMISSION_REPO/jean_zay/raw/radio_reconstruction_tools/large/jobs/large_run_img64_unrolled_n15_prior_DRUNet_PSF_finufft_4gpus_a100.sh
...
BASE_NAME=large_run_img64_unrolled_n15_prior_DRUNet_PSF_finufft_4gpus
