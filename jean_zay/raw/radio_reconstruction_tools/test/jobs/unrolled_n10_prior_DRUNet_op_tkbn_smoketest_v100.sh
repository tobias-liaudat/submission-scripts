#!/bin/bash
#SBATCH --job-name=rrt_smoke_unrolled_DRUNet_tkbn_v100    # nom du job
...
CONFIG=$SUBMISSION_REPO/jean_zay/raw/radio_reconstruction_tools/configs/unrolled_n10_prior_DRUNet_op_tkbn_smoketest.yaml
...
RUN_NAME=unrolled_n10_prior_DRUNet_op_tkbn
