#!/bin/bash
#SBATCH --job-name=rrt_unrolled_psf_DRUNet_finufft_a100
...
# ===========================================================================
# Self-chaining A100 training job (auto-resubmits until training completes).
...
# Launch:  cd .../jobs/logs && sbatch ../unrolled_psf_n18_prior_DRUNet_op_finufft_a100.sh
# ===========================================================================
...
JOB_SCRIPT=/lustre/fswork/projects/rech/ney/ulx23va/projects/radio/repos/submission-scripts/jean_zay/raw/radio_reconstruction_tools/jobs/unrolled_psf_n18_prior_DRUNet_op_finufft_a100.sh
CONFIG=$SUBMISSION_REPO/jean_zay/raw/radio_reconstruction_tools/configs/unrolled_psf_n18_prior_DRUNet_op_finufft_a100.yaml
OUTPUT_ROOT=/lustre/fswork/projects/rech/ney/ulx23va/projects/radio/outputs/trained_models

BASE_NAME=unrolled_psf_n18_prior_DRUNet_op_finufft_a100
