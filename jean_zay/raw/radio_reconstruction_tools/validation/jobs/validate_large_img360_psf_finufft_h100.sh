#!/bin/bash
#SBATCH --job-name=rrt_validate_large_img360_psf_finufft
...
# Validate the finished img360 PSF/finufft (unrolled_psf) large run: plots the training metrics, computes
...
BASE=large_run_img360_unrolled_n15_prior_DRUNet_PSF_finufft_4gpus
RUN_DIR=""
...
# --n-eval / --batch-size tuned for this image size + backend (img360 PSF/finufft (unrolled_psf)).
