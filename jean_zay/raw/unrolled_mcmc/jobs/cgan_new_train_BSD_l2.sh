#!/bin/bash
#SBATCH --job-name=cgan_new_train_GaussDeblur_BSD_l2    # nom du job
...
srun python -u unrolled_cgan.py \
    --config /lustre/fswork/projects/rech/rbn/ulx23va/projects/unrolled_cGAN/repos/submission-scripts/jean_zay/raw/unrolled_mcmc/configs/args_new_cGAN_BSD_l2.yml
