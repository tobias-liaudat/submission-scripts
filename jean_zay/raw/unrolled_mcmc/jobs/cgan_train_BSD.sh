#!/bin/bash
#SBATCH --job-name=cgan_train_GaussDeblur_BSD    # nom du job
...
srun python -u unrolled_cgan.py \
    --config /lustre/fswork/projects/rech/rbn/ulx23va/projects/unrolled_cGAN/repos/submission-scripts/jean_zay/raw/unrolled_mcmc/configs/args_BSD.yml
