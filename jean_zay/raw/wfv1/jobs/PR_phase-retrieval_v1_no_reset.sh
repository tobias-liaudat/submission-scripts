#!/bin/bash
#SBATCH --job-name=PR_no_reset_wfv1_test_n1_    # nom du job
...
#SBATCH --output=PR_no_reset_wfv1_test_n1_%j.out  # nom du fichier de sortie
#SBATCH --error=PR_no_reset_wfv1_test_n1_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
