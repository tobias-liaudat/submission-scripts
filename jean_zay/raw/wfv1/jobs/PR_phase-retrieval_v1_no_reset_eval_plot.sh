#!/bin/bash
#SBATCH --job-name=PR_no_reset_wfv1_test_n1_eval_plot_    # nom du job
...
#SBATCH --output=PR_no_reset_wfv1_test_n1_eval_plot_%j.out  # nom du fichier de sortie
#SBATCH --error=PR_no_reset_wfv1_test_n1_eval_plot_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _wf_PR_no_reset_12_cycles_v0 --random_seed 5000"
opt[1]="--id_name _wf_PR_no_reset_12_cycles_v1 --random_seed 5100"
opt[2]="--id_name _wf_PR_no_reset_12_cycles_v2 --random_seed 5200"
opt[3]="--id_name _wf_PR_no_reset_12_cycles_v3 --random_seed 5300"

cd $WORK/wfv2/repos/v1-phase-retrieval/wf-psf/long-runs/

srun python -u ./train_eval_plot_script_click_multi_cycle.py \
    --base_id_name _wf_PR_no_reset_12_cycles_ \
    --total_cycles 9 \
    --saved_cycle cycle9 \
