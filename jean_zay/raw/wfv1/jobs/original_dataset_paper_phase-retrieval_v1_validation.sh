...
#SBATCH --output=PR_original_dataset_validation_wfv1_test_n1_%j.out  # nom du fichier de sortie
#SBATCH --error=PR_original_dataset_validation_wfv1_test_n1_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _original_dataset_wf_PR_NewPRoj_12_cycles_v0 --random_seed 5000"
...
srun python -u ./train_eval_plot_script_click_multi_cycle.py \
    --base_id_name _original_dataset_wf_PR_NewPRoj_12_cycles_ \
    --total_cycles 12 \
    --saved_cycle cycle12 \
    ...
    --base_path /lustre/fswork/projects/rech/rbn/ulx23va/projects/wf_projects/phase_retrieval_paper/outputs/wf_output_phase_retrieval_run/ \
    --metric_base_path /lustre/fswork/projects/rech/rbn/ulx23va/projects/wf_projects/phase_retrieval_paper/outputs/wf_output_phase_retrieval_run/metrics/ \
    --chkp_save_path /lustre/fswork/projects/rech/rbn/ulx23va/projects/wf_projects/phase_retrieval_paper/outputs/wf_output_phase_retrieval_run/chkp/ \
    --plots_folder plots/ \
    --model_folder chkp/ \
