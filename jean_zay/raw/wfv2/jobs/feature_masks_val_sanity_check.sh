#!/bin/bash
#SBATCH --job-name=feature_mask_sanity_check_v0_    # nom du job
...
#SBATCH --output=feature_mask_sanity_check_v0_%j.out  # nom du fichier de sortie
#SBATCH --error=feature_mask_sanity_check_v0_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
