#!/bin/bash
#SBATCH --job-name=v1_train_masked_and_binary_stars_then_q3_removed_    # nom du job
...
wavediff -c /lustre/fswork/projects/rech/rbn/ulx23va/projects/wf_projects/real_data_processing_conference/submission-scripts/jean_zay/raw/wfv2_real_data/configs/v1_train_masked_and_binary_stars_then_q3_removed/configs.yaml \
